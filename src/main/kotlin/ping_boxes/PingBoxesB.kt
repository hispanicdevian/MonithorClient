...
@Composable
@Preview
fun pingBoxesB(subList: List<Boolean>) {
...
// Title
    val ipTitleA0 by remember { mutableStateOf(readTiFile(4)) }
    val ipTitleA1 by remember { mutableStateOf(readTiFile(5)) }
    val ipTitleA2 by remember { mutableStateOf(readTiFile(6)) }
    val ipTitleA3 by remember { mutableStateOf(readTiFile(7)) }
